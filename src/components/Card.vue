...
const selectedId = ref(237);
const setSelectedId = (id) => (selectedId.value = id);
const getSelectedId = computed(() => selectedId.value);
</script>

<template>
  <div class="flex font-sans bg-white my-10 rounded-md">
    <div class="flex-none w-48 relative">
      <img
        :src="`https://picsum.photos/id/${getSelectedId}/200/300`"
        alt=""
